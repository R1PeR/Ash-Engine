...
static void Debug_ShowMisc(Entity2D* ent, uint32_t entSize, Sprite* spr, uint32_t sprSize, Collider2D* col,
                           ...
                           uint32_t animSize, AudioData* aud, uint32_t audSize)
{
    ...
    if (ImGui::CollapsingHeader("Objects"))
    {
        ...
        {
            ImGui::Text("Entity count: %d", entSize);
        ...
        {
            ImGui::Text("Sprites count: %d", sprSize);
            for (uint32_t i = 0; i < sprSize; i++)
            {
        ...
        {
            ImGui::Text("Colliders count: %d", colSize);
        ...
        {
            ImGui::Text("Textures count: %d", texSize);
        ...
        {
            ImGui::Text("AnimatedSprites count: %d", animSize);
            for (uint32_t i = 0; i < animSize; i++)
            {
        ...
        {
            ImGui::Text("Audio count: %d", audSize);
            for (uint32_t i = 0; i < audSize; i++)
            {
                           ...
                           uint32_t animSize, AudioData* aud, uint32_t audSize)
{
    ...
    Debug_ShowMisc(ent, entSize, spr, sprSize, col, colSize, tex, texSize, anim, animSize, aud, audSize);
