...
- [x] Implement basic enemy patrol behavior
- [x] Implement basic enemy chase behavior when player is in sight
- [x] Implement rendeging of player and enemies on the map
